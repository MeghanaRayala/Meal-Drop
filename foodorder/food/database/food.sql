...
(2, 'Fries', 50, 'Welcome to a world of pure culinary delight, where we present the epitome of comfort food - our tantalizingly crisp and irresistibly delicious French Fries! At [Your Restaurant Name], we have perfected the art of crafting the most heavenly fries that will take your taste buds on a journey of pure satisfaction.', './images/fries.jfif', 'ENABLE'),
